...
public class XposedHookUtils {
    ...
    public static JSONObject checkXposedInjet(Context context) {
        ...
        try {
            ...
            jsonObject.put("xposedApp", xposedHookBean.isXposedApp() + "");
            jsonObject.put("xposedImei", xposedHookBean.isXposedImei() + "");
            jsonObject.put("xposedSerial", xposedHookBean.isXposedSerial() + "");
            jsonObject.put("xposedSsid", xposedHookBean.isXposedSsid() + "");
            jsonObject.put("xposedMac", xposedHookBean.isXposedMac() + "");
            jsonObject.put("xposedAddress", xposedHookBean.isXposedAddress() + "");
            jsonObject.put("xposedAndroidId", xposedHookBean.isXposedAndroidId() + "");
            jsonObject.put("xposedImsi", xposedHookBean.isXposedImsi() + "");
            jsonObject.put("xposedLatitude", xposedHookBean.isXposedLatitude() + "");
            jsonObject.put("xposedLongitude", xposedHookBean.isXposedLongitude() + "");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return jsonObject;
