 ...
 */
class BluetoothFragment : NormalFragment() {
    ...
    override fun createViewModel(): BaseViewModel<Pair<String, String>> {
        return ViewModelProvider(this).get(BluetoothViewModel::class.java)
    }
    
    override val normalInfo: List<Pair<String, String>>
        get() = (viewModel as BluetoothViewModel).getBluetoothInfo(requireContext())
}
